...
include "../circomlib-circom2.1/circuits/poseidon.circom";
include "../prove1/prove1.circom";
template chunk_enc(){
    signal input MK_0;
    signal input MK_1;
    signal input nonce;
...
template PoD(){
    ...
    // check sk_payee 
    component payee_check = sk_hash_checker();
    ...
    // check sk_payer
    component payer_check = sk_hash_checker();
...
component main {public [h_sk_payee, h_sk_payer, r, COM_r]} = PoD();